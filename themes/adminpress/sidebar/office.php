<li class="nav-devider"></li>
    ...
    <li> <a class=" waves-effect waves-dark" href="<?php echo site_url('office/dashboard') ?>" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard <span class="label label-rouded label-themecolor pull-right">4</span></span></a>
    ...
    <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Realisasi Program TJSL</span></a>
        <ul aria-expanded="false" class="collapse">
            <li><a href="<?php echo site_url('office/realisasi_tjsl') ?>">List Realisasi TJSL</a></li>
        </ul>
    </li>
